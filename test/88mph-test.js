...
describe("88mph", function() {
  it("Run 88mph example for aave", async function() {
   ...
   console.log(fundingNFT.address)
    ...
    var d = new Date();
    console.log("max deposit period", MaxDepositPeriod)
    console.log("max deposit period", MinDepositPeriod)
    await dInterestPool.deposit(mintAmount, 1624651492+MaxDepositPeriod)
    ...
    console.log(await getTokenBalance(mph, acc0))
    console.log(await getTokenBalance(stablecoin, dInterestPool))
    console.log(await getTokenBalance(stablecoin, lendingPool))
